...
from v5 import model, criterion, optimizer
...
def train(model, train_dl, val_dl, optim, crit, model_path):
    ...
    plt.legend()
    plt.show()
    save_model(model, optimizer, "./model-v5-full.pth")
    plt.savefig("model-v5-t-v-l.png")


if __name__ == "__main__":
    train(model, cap_train_dl, cap_val_dl, optimizer, criterion, "./model-v5.pth")
